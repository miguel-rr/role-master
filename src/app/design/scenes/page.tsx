...
const SCENES: Scene[] = [
  ...
  },
  {
    ...
    background: byId('scenes/fr/cragmaw-hideout'),
    focus: '50% 45%',
  ...
  },
  {
    id: 'palace',
    label: 'Palacio',
    place: 'Sala del Trono de Neverwinter',
    chapter: 'Capítulo IX · Audiencia',
    time: 'Mañana · Velas aún encendidas',
    background: byId('scenes/fr/castleperilous-throneofbloodstone'),
    focus: '50% 35%',
    ...
    narration: [
      'La sala es más alta que ancha y está pensada para que quien entra se sienta pequeño. Funciona. Vuestras botas dejan barro de Phandalin sobre un mármol que probablemente vale más que todo lo que habéis robado en vuestra vida, Nissa.',
    ...
    atmosphere: 'dust',
    grade: 'linear-gradient(180deg, rgba(60,10,10,0.2), rgba(20,5,5,0.4))',
    accent: '#c19429',
  },
  {
    id: 'forest',
